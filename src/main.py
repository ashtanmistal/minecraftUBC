...
from src.geojson import sidewalk_placer, streetlight_handler, traffic_impactors, uel_trail_placer
...
def main():
    world_directory = os.path.join(PROJECT_DIRECTORY, "world/TRAILS")
